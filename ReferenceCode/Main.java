...
public class Main {
	...
	public static void main (String[] args) {
        ...
        for (int i = 0; i < input.length; i++) {
            ...
            requests.add(trackNumber);
        }
		

        //FCFS.doFCFS(requests, initialHeadPosition);
        //SCAN.runScan(requests, initialHeadPosition);
        //CSCAN.runCScan(requests, initialHeadPosition);
        //LOOK.runLook(requests, initialHeadPosition);
        CLOOK.runCLook(requests, initialHeadPosition);
	}
